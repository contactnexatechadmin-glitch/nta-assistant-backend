...
const REGLE_FORMATAGE_WHATSAPP =
  ...
  "IMPORTANT - Élisions (l', d', n', qu', j', etc.) : WhatsApp exige un espace ou un début de mot juste avant l'astérisque pour reconnaître le gras. Si tu places l'astérisque APRÈS l'apostrophe (ex : \"L'*heure*\"), WhatsApp ne reconnaît PAS le gras et affiche les astérisques tels quels comme du texte parasite — c'est une ERREUR À NE JAMAIS FAIRE. " +
  "La bonne méthode : place TOUJOURS l'astérisque AVANT l'article élidé, pour englober l'article et le mot ensemble comme un seul bloc en gras. Exemple correct : \"*l'heure*\" (astérisque avant le \"l\", pas après l'apostrophe), \"*qu'il*\", \"*d'accord*\". Ne saute jamais le gras à cause d'une élision — utilise simplement cette bonne méthode à chaque fois.";
...
const REGLE_CONFIRMATION_COMMANDE =
  "\n\nIMPORTANT - Confirmation de commande : avant de pouvoir récapituler une commande, tu DOIS avoir obtenu du client au minimum ces 2 informations précises : (1) le produit, (2) le prix exact du produit tel qu'indiqué dans le catalogue (jamais un prix approximatif ou négocié sans validation via l'alerte prévue). " +
  "Demande TOUJOURS aussi l'adresse de livraison et le jour/heure souhaités avant de récapituler. Mais si le client confirme clairement son achat (oui, je confirme, d'accord, etc.) sans avoir donné l'adresse et/ou le jour/heure malgré ta relance, NE BLOQUE PAS la commande : récapitule quand même avec les infos disponibles, indique clairement \"(adresse à préciser)\" et/ou \"(jour/heure à préciser)\" pour les champs manquants, et termine TOUJOURS ta phrase par exactement : \"Vous confirmez cette commande ?\" (jamais reformulé autrement). " +
